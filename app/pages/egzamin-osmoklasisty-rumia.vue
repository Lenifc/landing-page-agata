    ...
    <UiSection id="cennik" data-track-section="pricing" variant="secondary" padding="lg" scroll-margin>
      ...
      >
        <template #description>
          ...
          Harmonogram układam tak, aby bez pośpiechu zrealizować materiał przed
          egzaminem.
        </template>
      </UiSectionHeader>
...
const examPriceFaqAnswer = `Grupowy kurs egzaminacyjny w 3-osobowej grupie: 108 zł / osoba za spotkanie 100 min (54 zł za 50 min). Miesięczna płatność to ${examGroupPayment}. Lekcje indywidualne 1:1: ${individualWeekly.price} (1×) / ${individualTwiceWeekly.price} (2×) za lekcję 50 min.`
