    ...
    <div class="mx-auto grid max-w-6xl gap-10 px-6 py-14 md:grid-cols-3">
      <div class="space-y-3">
        <p class="font-serif text-xl font-semibold text-foreground">
          <img src="/talkateria-logo-mono.svg" alt="Talkateria - angielski w Rumi" class="h-11 w-auto sm:h-12"
      ...
      <div class="space-y-3">
        ...
        <ul class="space-y-2 text-sm text-muted-foreground">
          ...
          <li class="relative inline-flex items-center gap-1.5">
            <a :href="CONTACT.phoneHref" class="transition-colors hover:text-foreground">
            ...
            <button type="button"
              ...
              aria-label="Informacja o kontakcie telefonicznym" aria-describedby="footer-phone-tooltip">
            ...
            <span id="footer-phone-tooltip" role="tooltip"
              class="pointer-events-none absolute bottom-full left-0 z-20 mb-3 w-[min(22rem,calc(100vw-3rem))] rounded-lg border border-border bg-card px-4 py-3 text-left text-xs leading-relaxed text-foreground opacity-0 shadow-lg transition-opacity peer-hover:opacity-100 peer-focus:opacity-100 md:left-auto md:right-0">
              Ze względu na charakter mojej pracy nie zawsze mogę odebrać
              telefon. Jeśli nie uda się Państwu ze mną skontaktować, proszę o
              wysłanie wiadomości SMS lub e-maila z krótką informacją dotyczącą
              celu kontaktu. Odpowiem lub oddzwonię najszybciej, jak to będzie
              możliwe.
            </span>
          </li>
          <li>
    ...
    <div class="border-t border-border">
      <div class="mx-auto max-w-6xl px-6 py-3">
        <p class="text-xs text-muted-foreground">
          ...
          <NuxtLink :to="ROUTES.privacyPolicy"
